...
class StringUtil extends Str
{
    ...
    {
        return preg_replace(static::getEmojiRegExp(), '', $str);
    }
     ...
     * @return bool
     */
    public static function hasEmoji(string $str): bool
    {
        return preg_match(static::getEmojiRegExp(), $str) === 1;
    }

    /**
     * hgoe+fuga@gmail.com を hoge@gmail.com にする
     * @param string $email
     * @return string
     */
